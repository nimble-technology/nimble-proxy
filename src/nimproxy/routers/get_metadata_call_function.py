...
def make_substrate_call_with_retry(substrate, module, extrinsic):
    return substrate.get_metadata_call_function(module, extrinsic)
...
async def get_metadata_call_function(request: GetMetadataCallRequest) -> dict:
    return make_substrate_call_with_retry(
        substrate_instance, request.module, request.extrinsic
    )
