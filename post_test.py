...
def make_substrate_call_with_retry(substrate, module, storage_function, address, block_hash):
...
async def get_balance_api(request: dict) -> dict:
    ...
    try:
        result = make_substrate_call_with_retry(substrate_instance, module, storage_function, address, block_hash)
